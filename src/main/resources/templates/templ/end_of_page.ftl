...
<![endif]-->
        ...
        <script src="${metronicPath}/assets/global/plugins/bootstrap-select/js/bootstrap-select.min.js" type="text/javascript"></script>
        <script src="${metronicPath}/assets/global/plugins/select2/js/select2.full.min.js" type="text/javascript"></script> <!--下拉菜单select-->
        <script src="${metronicPath}/assets/global/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>
        <script src="${metronicPath}/assets/global/plugins/bootstrap-growl/jquery.bootstrap-growl.min.js" type="text/javascript"></script>
        <script src="${metronicPath}/assets/global/scripts/datatable.js"	type="text/javascript"></script> 
		<script src="${metronicPath}/assets/global/plugins/datatables/datatables.min.js" type="text/javascript"></script>
		<script src="${metronicPath}/assets/global/plugins/datatables/plugins/bootstrap/datatables.bootstrap.js" type="text/javascript"></script>
        ...
        <!--加载myapp中的插件-->
        <script src="/static/myapp/plugins/jquery.form.js" type="text/javascript"></script>
        <script src="/static/myapp/js/base.js" type="text/javascript"></script>
